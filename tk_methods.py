...
class TkMethods(FileHandling):
    ...
    def main_window (self):
        ...
        self.main.geometry("500x900") #Main window Size
    ...
    def save_inputs(self):
        txt = FileHandling()
        txt.save_inputs(self.input_name.get(), self.input_age.get(), self.input_address.get(), self.input_number.get(), self.var.get(), self.symptoms())
        txt.storage_file()